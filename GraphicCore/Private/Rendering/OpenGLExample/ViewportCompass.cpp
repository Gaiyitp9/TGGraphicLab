...
{
    ViewportCompass::ViewportCompass() : m_vertexShader("Shaders/GLSL/ViewportCompass.vert", ShaderStage::Vertex),
        ...
        }
    {
        ...
        glVertexAttribPointer(0, 3 * sizeof(float), GL_FLOAT, GL_FALSE, 3 * sizeof(float), nullptr);
        glEnableVertexAttribArray(0);
        glVertexAttribPointer(1, 3 * sizeof(float), GL_FLOAT, GL_FALSE, 3 * sizeof(float),
