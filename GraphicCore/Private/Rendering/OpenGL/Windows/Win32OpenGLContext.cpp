...
*****************************************************************/
#include "Rendering/OpenGL/Windows/Win32Win32OpenGLContext.h"
#include "Exception/Windows/Win32Exception.h"
#include "glad/wgl.h"

namespace TG::Rendering
{
    Win32OpenGLContext::Win32OpenGLContext(HDC hdc)
	    : m_hdc{ hdc }
    {
    	LoadWGLExtension();
	...
	void Win32OpenGLContext::MakeCurrent() const
	{
    	wglMakeCurrent(m_hdc, m_wglContext);
	}

    void Win32OpenGLContext::SetVSync(bool enable) const
    {
        wglSwapIntervalEXT(enable ? 1 : 0);
    }

    void Win32OpenGLContext::Present() const
    {
		::SwapBuffers(m_hdc);
    }

    void Win32OpenGLContext::LoadWGLExtension() const
    {
    	WNDCLASS wc{};
    	wc.style = CS_OWNDC;
