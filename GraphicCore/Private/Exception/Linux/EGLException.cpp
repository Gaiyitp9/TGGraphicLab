    ...
    EGLException EGLException::Create(std::string_view message)
    {
        ...
        switch (error)
        {
            case EGL_NOT_INITIALIZED:
                errorMsg = "EGL is not initialized, or could not be initialized, for the "
            ...
            case EGL_BAD_CURRENT_SURFACE:
                errorMsg = "The current surface of the calling thread is a window, pixel buffer or pixmap "
            ...
            case EGL_BAD_SURFACE:
                errorMsg = "An EGLSurface argument does not name a valid surface (window, pixel buffer "
                           "or pixmap) configured for GL rendering.";
                break;
            case EGL_BAD_MATCH:
                errorMsg = "Arguments are inconsistent (for example, a valid context requires "
            ...
            case EGL_CONTEXT_LOST:
                errorMsg = "A power management event has occurred. The application must destroy all "
