...
namespace TG::Editor
{
	...
	Win32OpenGLImGuiContext::Win32OpenGLImGuiContext(HWND hwnd)
	{
    	// 初始化IMGUI
    	IMGUI_CHECKVERSION();
    	ImGui::CreateContext();
	...
	Win32OpenGLImGuiContext::~Win32OpenGLImGuiContext()
	{
	...
	void Win32OpenGLImGuiContext::NewFrame()
	{
	...
	void Win32OpenGLImGuiContext::Render()
	{
