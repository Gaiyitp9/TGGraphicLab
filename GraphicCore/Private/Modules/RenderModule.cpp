...
#include "Rendering/OpenGLExample/OpenGLRenderer.h"
...
namespace TG
{
    ...
    void RenderModule::PlugInVideoPort(const std::weak_ptr<IDefaultVideoPort>& videoPort,
    	const std::weak_ptr<ITimer>& timer)
    {
    	...
    	// m_Renderer = std::make_shared<OpenGLRenderer>(videoPort, timer);
    }
